...
def main():
    ...
    try:
        if req.get(r'https://graph.microsoft.com/beta/me',headers=headers).status_code == 200:
            num1+=1
            print("1调用成功"+str(num1)+'次')
        if req.get(r'https://graph.microsoft.com/v1.0/me/drive',headers=headers).status_code == 200:
            num1+=1
            print("2调用成功"+str(num1)+'次')
        if req.get(r'https://graph.microsoft.com/beta/drive/root',headers=headers).status_code == 200:
            num1+=1
        ...
        if req.get(r'https://api.powerbi.com/beta/myorg/apps',headers=headers).status_code == 200:
            num1+=1
            print('8调用成功'+str(num1)+'次') 
